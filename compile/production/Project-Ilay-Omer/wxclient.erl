...
start() ->
  ...
  wxButton:connect(ButtonSend, command_button_clicked, [{callback, fun handle_event/1}]),
...
handle_event(#wx{event=#wxCommand{type=command_button_clicked }}) ->
  ...
  Frame = wxFrame:new(Window2, ?wxID_ANY, "Popup"),
  Text = io_lib:format("Pressed Button ~n"),
